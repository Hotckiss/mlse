...
public enum Feature {
    ...
    ImportsTop1C("ImportsTop1C", 117),
    ImportsTop1A("ImportsTop1A", 118),
    ImportsTop2C("ImportsTop2C", 119),
    ImportsTop2A("ImportsTop2A", 120),
    ImportsTop3C("ImportsTop3C", 121),
    ImportsTop3A("ImportsTop3A", 122),
    ImportsTop4C("ImportsTop4C", 123),
    ImportsTop4A("ImportsTop4A", 124);
