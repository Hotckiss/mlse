...
/**
 * Commits history analyzer
 */
public class GitBlameAnalyzer {

    /**
     * Extracts git blame info
     * @param repo git repo
     * @param firstLine fragment start
     * @param lastLine fragment end
     * @param filePath path to file with fragment
     * @throws GitAPIException if git error occurred
     */
