...
class File2Vec:
    ...
    def __init__(self, config, model, model_info, data_dir, k=1000):
        self.model = model
                ...
                for file in file_list:
                    ...
                    for method in methods:
                        ...
                        try:
                            ...
                            if debug:
                                print(
                                    "Error for method {} in file {}. Note this may simply be caused by the method being a constructor".format(
                                        method, file))
                            print("\nException message:\n")
                            print(e)
                            print("=====================")
